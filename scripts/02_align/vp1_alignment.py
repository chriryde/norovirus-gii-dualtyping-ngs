...
INPUT_FASTA = PROJECT_ROOT / paths_config["vp1_fasta"]

#QC_DIR = PROJECT_ROOT / paths_config["qc_dir"]
#OUTPUT_EXCLUDED = PROJECT_ROOT / paths_config["output_excluded"]
OUTPUT_FASTA = PROJECT_ROOT / paths_config["output_vp1"]
VP1_LOG = PROJECT_ROOT / paths_config['vp1_log']


try:
    print("running mafft")
    with open(OUTPUT_FASTA, "w") as out_f, open(VP1_LOG, "w") as out_log:
...
with open(VP1_LOG, "r") as in_handle:
